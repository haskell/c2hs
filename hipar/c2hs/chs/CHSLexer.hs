...
--
--  Version $Revision: 1.17 $ from $Date: 2002/03/20 03:50:07 $
--
...
--     without lexing identifiers (as the latter may containg single quotes as
--     part of their lexeme).  Thus, we special case '"'.  This is still a
